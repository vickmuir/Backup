...
Prior to interacting with your EVault Backup service within the [{{site.data.keyword.slportal}}](https://control.softlayer.com//){:new_window}, the Storage screen for EVault must be accessed.  Follow the steps below to access the Storage screen for EVault.
