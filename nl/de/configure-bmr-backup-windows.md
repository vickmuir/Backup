...
Sie müssen das Plug-in für BMR (Bare Metal Restore, Bare-Metal-Wiederherstellung) erwerben, um eine BMR-Sicherung durchführen zu können. BMR ist nur für Bare-Metal-Server mit Windows verfügbar. Bei einer virtuellen Serverinstanz (VSI) gibt es keine BMR-Option.
...
4. Wählen Sie bei **Sicherungsquellentyp** im Pulldown-Menü den Typ des Dateisystems aus, aus dem die Sicherung ausgeführt werden soll, und klicken Sie dann auf **Weiter**.
...
8. In der Anzeige werden Verschlüsselungsoptionen und erweiterte Sicherungsoptionen angezeigt. Normalerweise werden diese Optionen nicht benötigt. Klicken Sie auf **Weiter**, um mit der Anzeige **Zeitplan erstellen** fortzufahren.   
9. Klicken Sie auf der Seite **Zeitplan erstellen** auf **Hinzufügen**, um einen zeitbasierten Sicherungsjob zu planen, oder klicken Sie auf **Weiter**, um einen manuellen Job zu erstellen.
  - Falls Sie einen manuellen Job erstellen wollen, fahren Sie mit der Ausführung Ihres neuen Jobs fort.
  ...
  - Nachdem Sie den Sicherungszeitplan konfiguriert haben, klicken Sie auf **OK**, um ihn zu speichern. Ihr geplanter Job wird zur Liste der geplanten Jobs hinzugefügt. 
