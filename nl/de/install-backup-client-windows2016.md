...
Dieser Artikel ist veraltet, da sich der Inhalt ausschließlich auf die föderierte Umgebung bezieht. Alle kommerziellen Kunden können die Anweisungen zur Erstinstallation und Konfiguration im [Lernprogramm zur Einführung](/docs/infrastructure/Backup?topic=Backup-getting-started#getting-started) ausführen.
{:deprecated}

# {{site.data.keyword.backup_notm}} unter Windows 2016 in der föderierten Umgebung konfigurieren
