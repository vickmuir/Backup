...
# Ports für die Kommunikation zwischen dem Sicherungsagenten und WebCC konfigurieren
...
Registrieren Sie Agenten bei WebCC und den Instanzen von {{site.data.keyword.backup_notm}}-Director immer mit FQDN, weil die IP-Adresse für diese Services sich möglicherweise ändern.

Ihre Server müssen mit WebCC und allen AMP-Proxy-Servern kommunizieren, damit WebCC ordnungsgemäß funktioniert, und zwar ungeachtet des Rechenzentrumsstandorts.

```
evregister.service.softlayer.com TCP 8086,8087
```

Weitere AMP-Proxy-Server können bei Bedarf hinzugefügt werden, um mehr {{site.data.keyword.backup_notm}}-Agenten auszuführen, die bei WebCC registriert sind.
