...
Prenez soin de démarrer votre connexion {{site.data.keyword.BluVPN}} pour pouvoir accéder au réseau privé {{site.data.keyword.BluSoftlayer_full}}. Sinon, le lien WebCC ne fonctionnera pas.
{:important}
...
3. Sélectionnez le serveur sur lequel se trouvent les fichiers à sauvegarder. Cliquez sur la flèche pour afficher le lien WebCC.
4. Cliquez sur **WebCC** pour lancer le client WebCC dans votre navigateur.
