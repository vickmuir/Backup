...
Use estas etapas para concluir uma restauração de arquivo por meio de outro computador usando o EVault Windows Central Control no Windows 2016.
...
11.	O Assistente de Configuração de Área Segura concluiu a coleta de suas informações, portanto, clique em **Concluir** para concluir o registro.
