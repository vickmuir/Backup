...
# Mudando a senha para o serviço de backup

Cada serviço de {{site.data.keyword.backup_full}} tem uma senha associada que é usada para acessar a
área segura no WebCC.
...
**Não** é o caso para o {{site.data.keyword.backup_notm}}.

As mudanças que são feitas na senha do IBM Cloud Backup no {{site.data.keyword.slportal}} são feitas
para o próprio serviço. Quando você mudar sua senha, tenha em mente que ela afeta seu serviço diretamente.
{:important}

## Mudando a senha do IBM Cloud Backup
