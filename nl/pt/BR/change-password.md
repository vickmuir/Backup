...
Cada serviço do {{site.data.keyword.backup_full}} tem uma senha associada que é usada para acessar a área segura no portal do {{site.data.keyword.backup_notm}}.
...
## Mudando a senha do {{site.data.keyword.backup_notm}}
