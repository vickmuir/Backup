...
10. Confirme se a tarefa de backup correta foi selecionada e clique em **Avançar**. A tarefa de restauração agora está configurada no server2.
...
15. Os arquivos preenchem a janela Conjunto de backup. Clique em **Avançar**.
