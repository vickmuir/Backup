...
本文章已淘汰，因為內容只適用於我們的聯邦環境，所有商業客戶可以遵循[入門指導教學](/docs/infrastructure/Backup?topic=Backup-getting-started#getting-started)，以進行起始安裝與配置。
{:deprecated}

# 在聯邦環境中的 Windows 2016 上配置 {{site.data.keyword.backup_notm}}
