...
可通过登录到为 {{site.data.keyword.backup_notm}} 服务指定的服务器并进行一系列交互操作来完成此任务。
...
6. 在“概要文件名称”字段中，输入保险库名称。
   ...
   保险库名称可以在 [{{site.data.keyword.slportal}} ![External link icon](../../icons/launch-glyph.svg "External link icon")](https://control.softlayer.com/){:new_window} 中获取。
   {:tip}
