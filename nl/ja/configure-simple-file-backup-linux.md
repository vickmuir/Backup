...
4. 「{{site.data.keyword.backup_notm}} ポータル・ログイン」リンクをクリックし、ブラウザーで {{site.data.keyword.backup_notm}} ポータル・クライアントを開始します。<br/>
...
5. **「次へ」**をクリックして先に進みます。
6. **「データ・ファイル (Data Files)」**ペインで、フォルダー・アイコンの横の **+** 記号と **-** 記号をクリックして、バックアップに含めるファイルとディレクトリーに移動します。
