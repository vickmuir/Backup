...
この内容は連邦政府環境にのみ適用されるもののため、この記事は推奨されません。すべての法人のお客様は [入門チュートリアル](/docs/infrastructure/Backup?topic=Backup-getting-started#getting-started) を参照して、最初のインストールおよび構成を行ってください。
{:deprecated}

# 連邦政府環境の Windows 2016 での {{site.data.keyword.backup_notm}} の構成
