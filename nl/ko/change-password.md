...
각 {{site.data.keyword.backup_full}} 서비스에는 WebCC 내의 저장소에 액세스하는 데 사용되는 연관된 비밀번호가 있습니다.
...
{{site.data.keyword.slportal}} 내에서 IBM Cloud 백업 비밀번호에 대한 변경은 서비스 자체에 대해 이루어집니다. 비밀번호를 변경할 때 이 변경이 서비스에 직접적으로 영향을 미친다는 점을 유념하십시오.
{:important}

## IBM Cloud 백업 비밀번호 변경
